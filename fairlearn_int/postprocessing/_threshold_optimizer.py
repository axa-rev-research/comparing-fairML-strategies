...
class ThresholdOptimizer(BaseEstimator, MetaEstimatorMixin):
    ...
    def fit(self, X, y, Z, sensitive_features, bld, **kwargs):
        """Fit the model.
        ...
        scores = _get_soft_predictions(self.estimator_, X, y, Z, self._predict_method, bld=bld)
    ...
    def predict(self, X, y, Z, sensitive_features, random_state=None, bld=None):
        ...
        return self.interpolated_thresholder_.predict(
            X, y, Z, sensitive_features=sensitive_features, random_state=random_state, bld=bld
        )

    def _pmf_predict(self, X, y, Z, sensitive_features):
        ...
        return self.interpolated_thresholder_._pmf_predict(
            X, y, Z, sensitive_features=sensitive_features
        )
...
def _reformat_and_group_data(
    ...
    #print(len(data_dict['sensitive_feature']))
    #print(len(data_dict['score']))
    #print(len(data_dict['label']))
