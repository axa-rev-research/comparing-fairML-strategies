...
if __name__ == '__main__':
  ...
  #  group_1_test_model = Model(group_1_test_data['prediction'].as_matrix(), group_1_test_data['label'].as_matrix())
    ...
    group_0_val_model = Model(group_0_val_data['prediction'], group_0_val_data['label'])
    group_1_val_model = Model(group_1_val_data['prediction'], group_1_val_data['label'])
    group_0_test_model = Model(group_0_test_data['prediction'], group_0_test_data['label'])
    group_1_test_model = Model(group_1_test_data['prediction'], group_1_test_data['label'])
